...
static var p1_control_list: Array = ["p1_left", "p1_right", "p1_up", "p1_down", "p1_grab", "p1_dash"]
static var p2_control_list: Array = ["p2_left", "p2_right", "p2_up", "p2_down", "p2_grab", "p2_dash"]
